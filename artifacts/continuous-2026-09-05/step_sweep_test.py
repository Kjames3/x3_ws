...
counts=Counter(); timed=OrderedDict(); pending=[]; joints=[]; positions=[]; worlds=[]; differences=[]; arrivals=[]
...
try:asyncio.run(run())
    ...
    np.savez_compressed('/home/jetson/x3_ws/artifacts/continuous-2026-09-05/step_points.npz',points=w,joints=j)
    open('/home/jetson/x3_ws/artifacts/continuous-2026-09-05/step_result.json','w').write(json.dumps(result,indent=2))
